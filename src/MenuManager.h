...
private:
    ...
    TimerOrMotoPartOrMenuElem* playMenuTask;
    TimerOrMotoPartOrMenuElem* optionsTask;
    TimerOrMotoPartOrMenuElem* helpTask;
    ...
    TimerOrMotoPartOrMenuElem* highscoreTask;
    ...
    TimerOrMotoPartOrMenuElem* clearHighscoreTask;
    TimerOrMotoPartOrMenuElem* fullResetTask;
    SettingsStringRender* confirmYesSetting;
    SettingsStringRender* confirmNoSetting;
    TimerOrMotoPartOrMenuElem* aboutTask;
    GameMenu* helpObjectiveMenu;
    TimerOrMotoPartOrMenuElem* helpObjectiveTask;
    GameMenu* helpKeysMenu;
    TimerOrMotoPartOrMenuElem* helpKeysTask;
    GameMenu* helpUnlockingMenu;
    TimerOrMotoPartOrMenuElem* helpUnlockingTask;
    GameMenu* helpHighscoreDescriptionMenu;
    TimerOrMotoPartOrMenuElem* helpHighscoreTask;
    GameMenu* helpOptionsDescriptionMenu;
    TimerOrMotoPartOrMenuElem* helpOptionsTask;
